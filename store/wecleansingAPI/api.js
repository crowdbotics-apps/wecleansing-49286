...
function modules_openai_audio_transcription_create(payload) {
  return wecleansingAPI.post(`/modules/openai/audio/transcription/`, payload)
}
function modules_openai_audio_translation_create(payload) {
  return wecleansingAPI.post(`/modules/openai/audio/translation/`, payload)
}
function modules_openai_chat_completions_create(payload) {
  return wecleansingAPI.post(`/modules/openai/chat/completions/`, payload)
}
function modules_openai_completion_create(payload) {
  return wecleansingAPI.post(`/modules/openai/completion/`, payload)
}
function modules_openai_edits_create(payload) {
  return wecleansingAPI.post(`/modules/openai/edits/`, payload)
}
function modules_openai_engines_retrieve(payload) {
  return wecleansingAPI.get(`/modules/openai/engines/`)
}
function modules_openai_engines_retrieve_2(payload) {
  return wecleansingAPI.get(`/modules/openai/engines/${payload.engine_id}/`)
}
function modules_openai_images_generations_create(payload) {
  return wecleansingAPI.post(`/modules/openai/images/generations/`, payload)
}
function modules_openai_models_retrieve(payload) {
  return wecleansingAPI.get(`/modules/openai/models/`)
}
function modules_openai_models_retrieve_2(payload) {
  return wecleansingAPI.get(`/modules/openai/models/${payload.model_id}/`)
}
